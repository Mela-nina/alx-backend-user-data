...
class Base():
    ...
    def __init__(self, *args: list, **kwargs: dict):
        """The initializes a Base instance
        """
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """This converts the object a JSON dictionary
        """
        result = {}
    ...
    def load_from_file(cls):
        """This loads all objects from file
        """
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """This searches all objects with matching attributes
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
